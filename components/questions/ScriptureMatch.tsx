...
export function ScriptureMatch({
  question,
  options,
  correctAnswer,
  explanation,
  ...
  return (
    <div className="space-y-6">
      <div className="bg-purple-50 border-l-4 border-purple-500 p-4 rounded">
        <p className="text-sm text-purple-700 font-medium mb-2">Scripture Reference</p>
        <h2 className="text-xl font-bold text-gray-900">{question}</h2>
      </div>

      <p className="text-gray-600 font-medium">Which reference is this from?</p>
